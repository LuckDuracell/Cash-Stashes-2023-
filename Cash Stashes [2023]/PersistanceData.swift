...
struct CashList: Hashable, Codable, LocalFileStorable {
...
struct CardList: Hashable, Codable, LocalFileStorable {
    static var fileName: String {
        return "CardList"
    }
    var name: String
...
struct SavingsList: Hashable, Codable, LocalFileStorable {
    static var fileName: String {
        return "SavingsList"
    }
    var name: String
